...
const { CLIENT_ID, GUILD_ID, TOKEN } = data.default.discord;
...
const commands = [
    ...
    new SlashCommandBuilder().setName("relevé").setDescription("Retourne le relevé des séances pour l'administration"),
